 ...
 */
public class FacebookOAuth2UserIdResolverImpl implements OAuth2UserIdResolver {
   ...
   */
  public FacebookOAuth2UserIdResolverImpl(final String userInformationRequestURI) {
